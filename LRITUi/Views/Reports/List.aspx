...
<asp:Content ID="Content4" ContentPlaceHolderID="HeadInfo" runat="server">
    ...
    <script src="<%= Url.Content("~/js/reports.js") %>" type="text/javascript"></script>
</asp:Content>


<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    <div class="content_block">
        <h2>Listado de Reportes <%= (int)ViewData["msgInOut"]!=0 ? "Enviados" : "Recibidos" %>&nbsp;<%= ViewData["referenceId"] != null ? "(SO)" : "" %></h2>
        <p>
            <div>
