$(document).ready(function() {
    ...
    url: virtualdir + '/PricingUpdate/GridData/',
        datatype: "json",
        width: 1020,
        height: 548,
        //"Message", "MessageId", "MessageType", "PricingFile", "Test", "TimeStamp" 
        colNames: ['Message', 'MessageId', 'MessageType', 'Test', 'MsgInOut', 'TimeStamp'],
        colModel: [
	                { name: 'Message', index: 'Message', width: 40 },
	                { name: 'MessageId', index: 'MessageId', width: 40 },
	                { name: 'MessageType', index: 'MessageType', width: 40 },
                    { name: 'Test', index: 'SystemStatus', width: 40 },
